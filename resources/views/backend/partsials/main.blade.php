...
<body>
    <div class="container-xxl position-relative d-flex bg-white p-0">
        <!-- Spinner Start -->
        <div id="spinner"
        ...
        @include('backend.partsials.sidebar')


        <!-- Content Start -->
        <div class="content">
            @include('backend.partsials.navbar')


            @yield('content')


            @include('backend.partsials.footer')
        </div>
        <!-- Content End -->
