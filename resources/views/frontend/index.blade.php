@extends('frontend.partsials.main')
@section('content')
    <!-- Carousel Start -->
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center text-start">
                        <div class="mx-sm-5 px-5" style="max-width: 900px;">
                            <h1 class="display-2 text-uppercase animated slideInDown mb-4 text-white">We Will Keep You
                                An Awesome Look</h1>
                            <h4 class="text-uppercase animated slideInDown mb-4 text-white"><i
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center text-start">
                        <div class="mx-sm-5 px-5" style="max-width: 900px;">
                            <h1 class="display-2 text-uppercase animated slideInDown mb-4 text-white">Luxury Haircut at
                                Affordable Price</h1>
                            <h4 class="text-uppercase animated slideInDown mb-4 text-white"><i
                                    class="fa fa-map-marker-alt text-primary me-3"></i>123 Street, New York, USA</h4>
                            <h4 class="text-uppercase animated slideInDown mb-4 text-white"><i
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex flex-column">
                        <img class="img-fluid w-75 align-self-end" src="{{ asset('frontend/img/about.jpg') }}"
                            alt="">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <p class="d-inline-block bg-secondary text-primary px-4 py-1">About Us</p>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="wow fadeInUp mx-auto mb-5 text-center" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block bg-secondary text-primary px-4 py-1">Services</p>
                <h1 class="text-uppercase">What We Provide</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative bg-secondary d-flex h-100 overflow-hidden p-5 ps-0">
                        <div class="bg-dark d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 60px; height: 60px;">
                            <img class="img-fluid" src="{{ asset('frontend/img/haircut.png') }}" alt="">
                        </div>
                        <div class="ps-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item position-relative bg-secondary d-flex h-100 overflow-hidden p-5 ps-0">
                        <div class="bg-dark d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 60px; height: 60px;">
                            <img class="img-fluid" src="{{ asset('frontend/img/beard-trim.png') }}" alt="">
                        </div>
                        <div class="ps-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item position-relative bg-secondary d-flex h-100 overflow-hidden p-5 ps-0">
                        <div class="bg-dark d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 60px; height: 60px;">
                            <img class="img-fluid" src="{{ asset('frontend/img/mans-shave.png') }}" alt="">
                        </div>
                        <div class="ps-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative bg-secondary d-flex h-100 overflow-hidden p-5 ps-0">
                        <div class="bg-dark d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 60px; height: 60px;">
                            <img class="img-fluid" src="{{ asset('frontend/img/hair-dyeing.png') }}" alt="">
                        </div>
                        <div class="ps-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item position-relative bg-secondary d-flex h-100 overflow-hidden p-5 ps-0">
                        <div class="bg-dark d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 60px; height: 60px;">
                            <img class="img-fluid" src="{{ asset('frontend/img/mustache.png') }}" alt="">
                        </div>
                        <div class="ps-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item position-relative bg-secondary d-flex h-100 overflow-hidden p-5 ps-0">
                        <div class="bg-dark d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 60px; height: 60px;">
                            <img class="img-fluid" src="{{ asset('frontend/img/stacking.png') }}" alt="">
                        </div>
                        <div class="ps-4">
            ...
            <div class="row g-0">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="bg-secondary h-100 d-flex flex-column justify-content-center p-5">
                        <p class="d-inline-flex bg-dark text-primary me-auto px-4 py-1">Price & Plan</p>
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="h-100">
                        <img class="img-fluid h-100" src="{{ asset('frontend/img/price.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="wow fadeInUp mx-auto mb-5 text-center" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block bg-secondary text-primary px-4 py-1">Our Barber</p>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-0">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="h-100">
                        <img class="img-fluid h-100" src="{{ asset('frontend/img/open.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="bg-secondary h-100 d-flex flex-column justify-content-center p-5">
                        <p class="d-inline-flex bg-dark text-primary me-auto px-4 py-1">Working Hours</p>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="wow fadeInUp mx-auto mb-5 text-center" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block bg-secondary text-primary px-4 py-1">Testimonial</p>
